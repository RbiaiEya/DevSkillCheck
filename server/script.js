...
var url = "http://localhost/PHP_Projects/DevSkillCheck/server/question/read.php";
...
xhr.onreadystatechange = function () {
  if (xhr.status === 200) {
    // La requête est terminée, et la réponse est reçue avec succès (statut 200 OK)
...
function showQuestions(index) {
  ...
  console.log(typeof questions);
  console.log(questions[index].id, " ", questions[index].question);
  console.log("questions[0] ", questions[0].question);
  ...
  let optionTag = `<div class="option"><span>${questions[index].option1}</span></div>
